...
Irole * CmdPrsP::GetMsgProcessor(UserDataMsg & _oUserDataMsg)
{
	...
	//	}
	//}
	m_channelInfo = byte.szInfo == "stdin_channel" ? 
		"stdout_channel" : byte.szInfo;
	std::cout << m_channelInfo << std::endl;
...
{
	return ZinxKernel::Zinx_GetChannel_ByInfo(m_channelInfo);
}
